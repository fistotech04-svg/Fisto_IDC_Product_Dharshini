...
const GalleryPopup = ({ onClose, settings = {}, popupSettings = {} }) => {
  ...
  const dragToSlide = !effectiveAutoPlay;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
            {!effectiveAutoPlay && images.length > 1 && (
              <button
                  className="absolute left-[3vw] z-[210] p-[0.5vw] text-black hover:text-gray-600 transition-all cursor-pointer"
            ...
            {!effectiveAutoPlay && images.length > 1 && (
              <button
                  className="absolute right-[3vw] z-[210] p-[0.5vw] text-black hover:text-gray-600 transition-all cursor-pointer"
