...
const Navbar = ({ onExport, onSave, onPreview, hasUnsavedChanges, saveSuccessInfo, isAutoSaveEnabled, onToggleAutoSave }) => {
        ...
        <div className="flex items-center gap-[0.8vw] min-w-[15vw] justify-end relative">
          ...
          {location.pathname.includes('customized_editor') && (
            <button 
              ...
              title="Preview"
            >
              <Icon icon="ic:baseline-preview" width="1.2vw" height="1.2vw" />
            </button>
          )}
