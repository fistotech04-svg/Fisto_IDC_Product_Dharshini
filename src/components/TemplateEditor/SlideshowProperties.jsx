...
const SlideshowProperties = ({ selectedElement, onUpdate, isOpen, onToggle, opacity, onUpdateOpacity, setPreviewSrc, setIsUpdatingDOM, currentPageVId, flipbookVId, folderName, flipbookName }) => {
  ...
  // Sync activeSlideIndex state to DOM for the SlideshowRunner
  useEffect(() => {
    if (selectedElement && selectedElement === hydratedElement) {
       selectedElement.setAttribute('data-active-index', activeSlideIndex.toString());
    }
  }, [activeSlideIndex, selectedElement, hydratedElement]);
