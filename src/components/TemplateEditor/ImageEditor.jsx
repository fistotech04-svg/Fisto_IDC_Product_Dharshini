        ...
        {isMainPanelOpen && (
          <div className="space-y-[1.25vw] px-[1.25vw] pb-[1.25vw] pt-[1vw]">
            <div className="space-y-[1vw]">
              <div className="flex items-center gap-[0.5vw]">
                <span className="text-[0.85vw] font-semibold text-gray-900 whitespace-nowrap">Upload your Image</span>
              ...
              {isSlideshow ? (
                ...
                <div className="space-y-[1vw] animate-in fade-in duration-300">
                  <div className="flex items-center justify-between relative z-20">
                    <span className="text-[0.75vw] font-semibold text-gray-900">Select the Image type :</span>
            ...
            {!isSlideshow && (
              <div className="space-y-[0.75vw]">
                <div className="flex items-center gap-[0.5vw]">
                  <DraggableSpan label="Opacity" value={opacity} onChange={setOpacity} className="text-[0.85vw] font-semibold text-gray-900 whitespace-nowrap" />
                  <div className="h-[0.1vw] w-full bg-gray-200" />
                </div>
                        ...
                        <div className="flex justify-between items-center">
                          <div className="flex items-center gap-[0.5vw]">
                            ...
                            <button 
                              ...
                              title={`Reset ${label}`}
                            >
                              <Icon icon="ix:reset" className="w-[1vw] h-[1vw]" />
                            </button>
                          </div>
